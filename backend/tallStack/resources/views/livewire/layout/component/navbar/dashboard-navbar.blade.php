            ...
            <div class="flex-1 flex justify-between px-4 sm:px-6">
                ...
                <div class="ml-2 flex items-center space-x-4 sm:ml-6 sm:space-x-6">
                    ...
                    <div class="relative flex-shrink-0" x-data="{ open: false }">
                        <div>
                            <button wire:click="toogleUserMenu()"  type="button" class="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                        ...
                        -->
                        <div  x-transition class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
