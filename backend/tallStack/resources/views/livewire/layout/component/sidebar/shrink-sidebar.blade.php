    ...
    <div  class="hidden min-h-screen w-24 bg-indigo-700 overflow-y-auto md:block sm:hidden relative">
        ...
        <div class="flex-shrink-0 flex border-t border-indigo-800 m-2 bottom-0 absolute ">
