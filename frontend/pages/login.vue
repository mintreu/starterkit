      ...
      <div class="relative sm:max-w-sm w-full">
        ...
        <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
          ...
          <form class="mt-10" ref="loginform" @submit.prevent="login">
            <!-- @csrf -->
            <!--            <form method="post" action="#" class="mt-10" ref="loginform" @submit.prevent="login">-->

            <div class="text-black">
              <input type="email" name="email" required autofocus placeholder="Enter Your Email" class="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
            </div>

            <div class="mt-7 text-black">
              <input type="password" name="password" required autofocus placeholder="Enter Password" class="mt-1 text-blue block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
            </div>
            ...
            <div class="mt-7">
              <div class="flex justify-center items-center">
                <label class="mr-2 text-black" >Don't have an account?</label>
